...
PIPELINE_CONFIG_PATH=pascal/checkpoint_pipeline.config
TRAINED_CKPT_PREFIX=pascal/model.ckpt-870894
EXPORT_DIR=pascal
...
--output_graph_path=${EXPORT_DIR}/customized_detector.binaryproto \
